            ...
            <div className="container">
                ...
                <div className="team-grid">
                    ...
                    <div className="team-member">
                        <img src="/images/rinat.jpeg" alt="Photo of Rinat Shakenov" />
                        ...
                        {/* <a href="[LINKEDIN_URL_RINAT]" target="_blank" rel="noopener noreferrer" className="linkedin-link">LinkedIn Profile</a> */}
                    </div>

                    {/* === TEAM MEMBER 2: Alan Rymov === */}
                    <div className="team-member">
                        <img src="/images/alan.jpeg" alt="Photo of Alan Rymov" />
                        <h4>Alan Rymov</h4>
                        <p className="role">IFRS 17 & Solvency II Consultant / Core Model Developer</p>
                        <p className="expertise">Fellow of the Society of Actuaries (FSA). Provides expert consulting on standards and contributes to core actuarial model development & validation.</p>
                    ...
                    <div className="team-member">
                        <img src="/images/bolat.jpeg" alt="Photo of Bolat Myrzakhmet" />
                        <h4>Bolat Myrzakhmet</h4>
                        <p className="role">Life Insurance IFRS 17 & Solvency II Consultant</p>
                        <p className="expertise">Specializes in applying IFRS 17/SII requirements to Life Insurance products. Background in Actuarial Consulting.</p>
                    ...
                    <div className="team-member">
                        <img src="/images/aika.jpeg" alt="Photo of Aizhan Shukatayeva" />
                        <h4>Aizhan Shukatayeva</h4>
                        <p className="role">General Insurance IFRS 17 & Solvency II Consultant</p>
                        <p className="expertise">Focuses on IFRS 17/SII implementation for General (Non-Life) lines. Combines Actuarial Consulting with GAAP knowledge.</p>
                    ...
                    <div className="team-member">
                        <img src="/images/vladimir.jpeg" alt="Photo of Vladimir Shevchenko" />
                        <h4>Vladimir Shevchenko</h4>
                        <p className="role">Core Model Developer</p>
                        <p className="expertise">Develops and implements core actuarial calculation engines using Actuarial Data Science techniques.</p>
                    ...
                    <div className="team-member">
                        <img src="/images/vitaly.jpeg" alt="Photo of Vitaliy Garshtya" />
                        <h4>Vitaliy Garshtya</h4>
                        <p className="role">Data Warehouse (DWH) Project Manager</p>
                        <p className="expertise">Manages DWH component build. Experienced in Big Data environments and relevant Cyber Security practices.</p>
                    ...
                    <div className="team-member">
                        <img src="/images/kuanysh.jpeg" alt="Photo of Kuanysh Tokhmetov" />
                        <h4>Kuanysh Tokhmetov</h4>
                        <p className="role">Data Engineer</p>
                        <p className="expertise">Designs and builds data pipelines, ETL processes. Proficient in SQL, Python, Data Modeling, DWH concepts, DB tech (PostgreSQL, Greenplum), Big Data tools (Spark, Kafka, Airflow).</p>
                     ...
                     <div className="team-member">
                        <img src="/images/vlad.jpeg" alt="Photo of Vladislav Frants" />
                        <h4>Vladislav Frants</h4>
                        <p className="role">DevOps & Database Administrator (DBA)</p>
                        <p className="expertise">Manages IT infrastructure, deployment pipelines (DevOps), and Oracle database administration (Multi-Certified OCP, OCE). Ensures stability and performance.</p>
